odoo.define("pos_product_available.ProductItemQty", function(require) {
    "use strict";
    ...
    models.PosModel = models.PosModel.extend({
        ...
        set_product_qty_available: function(product, qty) {
            ...
            this.sync_available_qty(product);
        },
        update_product_qty_from_order_lines: function(order) {
            ...
            order.orderlines.each(function(line) {
                ...
                self.sync_available_qty(product);
            });
        ...
        sync_available_qty: function(product) {
