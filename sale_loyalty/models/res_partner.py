...
class ResPartner(models.Model):
    ...
    sale_loyalty_points = fields.Float(compute='compute_partner_loyalty_points', string='Sale Loyalty Points', digits='Sale Loyalty', help='The loyalty points the user won as part of a Loyalty Program')
