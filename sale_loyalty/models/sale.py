...
class SaleOrder(models.Model):
    ...
    def action_redeem_points(self):
        ...
        default_points = min(self.partner_id.sale_loyalty_points + self.points_spent, float_round(self.amount_total / product.lst_price, precision_digits=pd) + self.points_spent)
